...
menu.add_command(label='MenuContextuele item 1')
menu.add_command(label='MenuContextuele item 2')
menu.add_separator()
menu.add_command(label='MenuContextuele item 3')
menu.add_command(label='MenuContextuele item 4')
