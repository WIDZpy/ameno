...
menu.add_command(label='Menu_contextuele item 1')
menu.add_command(label='Menu_contextuele item 2')
menu.add_separator()
menu.add_command(label='Menu_contextuele item 3')
menu.add_command(label='Menu_contextuele item 4')
